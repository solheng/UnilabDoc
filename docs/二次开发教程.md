...
| 3 | open_aipod_project  | 打开aipod工程函数 |aipod |
    ...
    graph_model.add_dynamic_file(name="动态文件名称", description="动态文件描述", rel_path='相对路径')

    graph_model.add_func_node(name="函数节点名称", is_private_cwd=False, function="""python 脚本""")
