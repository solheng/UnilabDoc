...
| 11  |UniLab| 仓库平台总称 |集成unicall和gfunc| |
...
#### 流程搭建的完整代码
    ...
    import shutil
    from unilab.persistence import Solution, create_default_solution, open_aipod_project
    ...
    if __name__ == '__main__':
        import logging
        from unilab.utils.log_helper import logger_helper
